          ...
          <div data-tab="creation" className="space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Relevez des défis quotidiens, hebdomadaires et spéciaux pour gagner des crédits, de l'expérience et des badges exclusifs.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg">
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-white">Créateur du jour</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Publiez 3 contenus de qualité</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg">
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-white">Stratège social</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Gagnez 500 followers</p>
                    </div>
                    <div className="text-right">
                ...
                <button className="w-full mt-4 px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg font-medium hover:from-yellow-600 hover:to-orange-600 transition-colors">
                  Voir tous les défis
                </button>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Découvrez des idées de contenu tendance et viral pour maximiser votre engagement sur TikTok, Instagram et YouTube.
                </p>
                <div className="space-y-3">
                  <div className="p-3 bg-gradient-to-r from-pink-50 to-red-50 dark:from-pink-900/20 dark:to-red-900/20 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                      <span className="text-lg">🎵</span>
                      <h4 className="font-medium text-gray-900 dark:text-white">Tutoriel Makeup Avant/Après</h4>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                      Transformation spectaculaire avec des produits abordables
                    </p>
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      <span>50k vues estimées</span>
                  ...
                  <div className="p-3 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                      <span className="text-lg">📷</span>
                      <h4 className="font-medium text-gray-900 dark:text-white">Recette Rapide 5 Minutes</h4>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                      Plat délicieux préparé en moins de 5 minutes
                    </p>
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      <span>75k vues estimées</span>
                      <span>9.2% engagement</span>
                    </div>
                  </div>
                </div>
                <button className="w-full mt-4 px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg font-medium hover:from-pink-600 hover:to-purple-700 transition-colors">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="px-3 py-2 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-lg text-sm font-medium hover:from-purple-600 hover:to-pink-700 transition-colors">
                  <Plus className="w-4 h-4 mr-2 inline" />
                  Planifier
                </button>
              </div>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Planifiez et organisez votre contenu à l'avance pour maintenir une présence constante sur vos réseaux sociaux.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg">
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="text-lg">🎵</span>
                    <h4 className="font-medium text-gray-900 dark:text-white">Tutoriel Makeup</h4>
                  </div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Planifié pour le 20/01</p>
                ...
                <div className="p-4 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg">
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="text-lg">📷</span>
                    <h4 className="font-medium text-gray-900 dark:text-white">Recette Rapide</h4>
                  </div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Planifié pour le 21/01</p>
                ...
                <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <h4 className="font-medium text-gray-900 dark:text-white">Conseils Fitness</h4>
                  </div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Publié le 19/01</p>
