    ...
    <div className="min-h-screen relative">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-row flex-wrap gap-4 justify-center mt-4">
            <a href="/apk/BeStrong.apk" download className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-12 py-4 rounded-full text-2xl font-semibold hover:shadow-xl transition-all duration-1000 flex items-center justify-center gap-2 whitespace-nowrap">
